	...
	<div class="container-fluid">
		...
		<c:choose>
			<c:when test="${cookie.username != null}">
				...
				<li class="dropdown">
					<a class="dropdown-toggle pull-right" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">${cookie.username.value} <span class="caret"></span></a>
