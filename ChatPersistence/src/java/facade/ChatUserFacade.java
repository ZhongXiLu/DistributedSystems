 ...
 * @author thomas
 */
@Stateless(mappedName = "java:global/ChatPersistence/ChatUserFacade")
public class ChatUserFacade extends AbstractFacade<ChatUser> implements facade.ChatUserFacadeRemote {
